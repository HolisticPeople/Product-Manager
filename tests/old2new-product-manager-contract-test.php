...
hp_pm_old2new_assert(str_contains($plugin, 'Version: 2.4.3'), 'Product Manager plugin header must be 2.4.3.');
hp_pm_old2new_assert(str_contains($plugin, "const VERSION = '2.4.3'"), 'Product Manager VERSION constant must be 2.4.3.');
