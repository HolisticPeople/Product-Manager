# Products Manager - agent entry point (read this first)

You are in Product-Manager, part of the HolisticPeople platform. The source of truth is
...
## YOUR LANE  (owner lane: `product-ops`)
OWNS:
  - ERP product fields
  - product metrics
  - admin REST tooling
MUST NOT OWN:
  - WooCommerce core product ownership
